...
<div class="application-form">
    <div class="container">
        <div class="col-md-8">
			<h3 class="contact_page_headings">Profil Bilgileri</h3><br>
            <h4 class="contact_page_headings">Kullanıcı  Bilgilerinizi Güncelleyelirsiniz.</h4>
            <?php foreach($kullanici as $kul){			?>
            <form  action="<?php echo base_url('Auth/kullanici_guncelle')?>"  name="contact-form-ajax" id="contact-form-ajax" method="post" enctype="multipart/form-data">
                <div class="result_class"></div><input type="text" name="name" value="<?php echo $kul->ad;?>" class="input-contact" placeholder="Kullanıcı Adı:">
                ...
                <div class="result_class"></div><input type="text" name="email" value="<?=$kul->email;?>" class="input-contact" placeholder="Eposta Adresiniz">
                ...
                <div class="result_class"></div><input type="text" name="meslek" value="<?=$kul->meslek;?>" class="input-contact" placeholder="Meslek:">
